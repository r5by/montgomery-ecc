...
class Test_numbthy(unittest.TestCase):
    ...
    def test_gcd(self):
        for testcase in (
        (1, 1, 1), (-1, 1, 1), (6, 0, 6), (0, 6, 6), (6, 6, 6), (1234, 5678, 2), (12345675, 34567890, 2469135)):
            self.assertEqual(numbthy.gcd(testcase[0], testcase[1]), testcase[2])

    def test_xgcd(self):
        for testcase in (
        (1, -1, 1, 0, -1), (6, 8, 2, -1, 1), (12345, 2345, 5, 87, -458), (98760, 76540, 20, 1898, -2449)):
        ...
        for testnum in range(10):
            ...
            try:
                ...
                raise AssertionError(
                    "***** Error in xgcd *****: {2} != ({0})*({3}) + ({1})*({4})".format(a, b, g, x, y))
    ...
    def test_is_prime(self):
        for testcase in (
        (1, False), (0, False), (-2, True), (19, True), (1236, False), (1237, True), (321197185, False)):
